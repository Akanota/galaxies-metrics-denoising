...
DATA_ROOT = '../data/sdss/snapnum_099/data'
HDF5_ROOT = '../data/sdss/snapnum_099'
STATS_FILE = f'../data/sdss99_{BOUND}_stats.p'
H5PY_PATH = f"../data/sdss99_{BOUND}_r%1d.h5"
TFRECORDS_PATH = f"../data/sdss99_{BOUND}_r%1dp%1d.tfrecords"
FITS_FILES = os.listdir(DATA_ROOT)

NUM_SAMPLES = 100
SAMPLE_PATH = f'../data/sdss99_{BOUND}_samples'
...
if __name__ == '__main__':
    ...
    save_samples(FITS_FILES[:NUM_SAMPLES])
    
    num_proccesses_mean = 4
    print('Computing mean...')
    with Pool(processes=num_proccesses_mean) as pool:
        files = splitList(FITS_FILES,num_proccesses_mean)
    ...
    if SAVE_TFRECORDS:
        ...
        with Pool(processes=PARTS_TFRECORDS) as pool:
            ...
            files = splitList(FITS_FILES, PARTS_TFRECORDS)
    ...
    with Pool(processes=PARTS_H5PY) as pool:
        ...
        files = splitList(FITS_FILES, PARTS_H5PY)
