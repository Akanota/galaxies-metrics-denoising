...
def compute_pr(source, target, nhood_size=3, row_batch_size=10000, col_batch_size=10000):
    ...
    return {'precision': results['precision'], 'recall': results['recall']}#results['precision'], results['recall']