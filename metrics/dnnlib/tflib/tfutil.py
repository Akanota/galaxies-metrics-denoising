...
def create_session(config_dict: dict = None, force_as_default: bool = False) -> tf.Session:
    ...
    if 'gpu_options' in cfg:
        config_proto = tf.ConfigProto(gpu_options=cfg['gpu_options'])
        cfg.pop('gpu_options', None)
    else:
        config_proto = tf.ConfigProto()

    # if 'device_count' in cfg:
    #     config_proto = tf.ConfigProto(device_count=cfg['device_count'])
    #     cfg.pop('device_count', None)
    # else:
    #    config_proto = tf.ConfigProto()
